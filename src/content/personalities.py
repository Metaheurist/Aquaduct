...
class PersonalityPreset:
    ...
    do_dont: list[str]
    # Optional: max words per TTS chunk in `shape_tts_text` (shorter = punchier pauses for comedic; longer for cozy).
    tts_max_chunk_words: int | None = None
