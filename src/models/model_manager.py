...
def model_options() -> list[ModelOption]:
    ...
    opts = [
        ...
        # Video (text-to-video / image-to-video — see docs/reference/models.md “Quick comparison”)
        ModelOption(
        ...
        ModelOption(
            "Wan 2.2 TI2V 5B (hybrid T2V/I2V — low VRAM)",
        ...
        ModelOption(
            "HunyuanVideo 1.5 480p I2V Step Distilled (community diffusers)",
        ...
        ModelOption(
            "SkyReels V2 I2V 1.3B 540P (human-centric)",
        ...
        ModelOption(
            "FramePack I2V HY (low-VRAM image-to-video)",
        ...
        ModelOption(
            "FramePack F1 I2V HY (anti-drift)",
