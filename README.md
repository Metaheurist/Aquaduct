...
- **Library**: browse finished **video** or **photo** projects under **`.Aquaduct_data/videos`** or **`.Aquaduct_data/pictures`** (depending on **Photo \| Video**), plus **`runs/`** workspaces; **search** by title/folder/meta; **Resume series** for incomplete multi-episode folders; refresh or open the library roots
