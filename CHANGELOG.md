...
- **Tests** ([`tests/test_kling_client.py`](tests/test_kling_client.py), [`tests/test_api_model_catalog.py`](tests/test_api_model_catalog.py)). **Docs**: [api_generation.md](docs/integrations/api_generation.md), [config.md](docs/reference/config.md), [models.md](docs/reference/models.md).
