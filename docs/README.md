...
| [ui](ui/) | Desktop UI (title-bar shortcuts include **F12** session guardrail bypass — [config](reference/config.md#session-guardrail-bypass)), branding, characters, **[Topics (tags + notes)](ui/topics.md)**, [**Video tab v2 / quality presets**](ui/video-tab-v2.md) |
