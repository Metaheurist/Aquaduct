...
- **Topics**
  ...
  - **Discover**: **News** and **Explainer** — headline-style suggestions from your tags. **Cartoon** and **Unhinged** — creative / story-shaped seeds (Firecrawl recommended on the API tab); approved items are added to that mode’s list
- **Tasks**
