...
- **Captions**
  - Word-by-word captions and optional **Key facts** card. The facts card is **drawn only** when **Video format** (Run tab) is **News** or **Explainer**; **Cartoon** and **Cartoon (unhinged)** runs skip it regardless of the Captions toggle ([`video_format_supports_facts_card`](../src/config.py)).
- **Branding**
